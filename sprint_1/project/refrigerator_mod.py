...
func.test_add(goods, 'Пельмени универсальные', 2, '2024-10-10')
func.test_add(goods, 'Вода', 0.5)
func.test_add(goods, 'Яйца куриные', 20, '2024-09-16')
