...
-- импорт данных из source1.craft_market_wide
SELECT order_id,
       order_created_date,
...
-- объединяем с данными из источника source2
-- source2.craft_market_masters_products мастер с описанием продукта
-- source2.craft_market_orders_customers покупатель с данными о заказе
UNION 
SELECT  t2.order_id,
...
-- объединяем с данными из источника source3
-- source3.craft_market_craftsmans данные о мастерах
-- source3.craft_market_customers данные о покупателях
-- source3.craft_market_orders данные о заказах
UNION
SELECT  t1.order_id,
...
-- Добавление нового источника данных external_source
-- external_source.craft_products_orders инфомация о мастерах, продуктах и заказах
-- external_source.customers информация о покупателях
UNION 
SELECT  t1.order_id,
        t1.order_created_date,
        t1.order_completion_date,
...
CREATE TEMPORARY TABLE tmp_sources_fact AS 
